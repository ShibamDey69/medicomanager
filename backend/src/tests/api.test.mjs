...
describe("API End-to-End Tests with manual cookie", () => {
  ...
  test("POST /users/login - should return auth data and set cookie", async () => {
    const payload = {
      idToken:
        "eyJhbGciOiJSUzI1NiIsImtpZCI6IjUwMDZlMjc5MTVhMTcwYWIyNmIxZWUzYjgxZDExNjU0MmYxMjRmMjAiLCJ0eXAiOiJKV1QifQ..LYFFvylVo1orBgg8BIXpM6oPWFF32BfyjCNmnNmfzeMW3HBmDlW-fMgXVHTVnHAZ_BD7A9J0cg0Dk5QSwWLLEQa21RiKZme9dEkpvtoCXisYxQjaY3FJ0VmPor4ZIhm5H2I8y204GLc-Otpq0d3IjBGE5exu39fl1pocppssQdTqSg7mTKhtig-zrrKZ-W0N48wKUMgsIUDDtsSq6YC3QGQC2_2ASzQcnFGtry0nNQ4n2uETXEg6Z6g2GVvYv0JHjhWsovJJDXBaABOIWv6Jx7rcswDxSyQ3E0k9WmG-14THRmCnDAsiK7ax5ta7oY3CeuQgKVKQR4u5uTRWDj9p2g",
    };
