...
export default function PrescriptionsPage() {
  ...
  const filteredPrescriptions = prescriptions
    .filter((prescription) => {
      ...
      const matchesDoctor =
        filterDoctor === "all" || prescription.doctor === filterDoctor;
      const matchesStatus =
  ...
  return (
    <AuthGuard>
      <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/10">
        {/* Enhanced Header with animations and modern styling */}
        {/* Enhanced Header */}
        <motion.header
        ...
        <div className="container mx-auto px-6 py-8 space-y-8">
          ...
          <div className="flex items-center justify-between px-1">
            <div className="flex items-center space-x-2">
              <p className="text-sm text-muted-foreground">
                ...
                prescription{filteredPrescriptions.length !== 1 ? "s" : ""}{" "}
                found
              </p>
              {(searchTerm ||
                filterDoctor !== "all" ||
          ...
          {/* Professional Prescriptions Grid */}
                        ...
                        <div className="space-y-2">
                          {prescription.medicines
                            ...
                            .map((medicine, idx) => (
                              <div
                                key={idx}
                                className="text-sm bg-muted/30 px-3 py-2 rounded-xl border border-border/30"
                              >
